...
class Solver_wrapper
{
    ...
    /**
     * This function converts the internal representation of the clauses to the tree representation.
...
public:
    ...
    /**
     * This function checks the satisfiability of the assertions modulo model.
     * @param assertions The assertions to check.
     * @param input model in form of a trail snapshot
     * @param variables_mapping mapping from terms to variables of the input model
     * @return The solver answer.
     */
